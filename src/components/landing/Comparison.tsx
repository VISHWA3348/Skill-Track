...
const Comparison: React.FC = () => {
  ...
  return (
    <section id="comparison" className="py-24 bg-white transition-colors">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">Traditional vs <span className="text-indigo-600">SkillTrack</span></h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            See how we compare against traditional paper-based and manual systems.
          </p>
        </div>

        <div className="bg-gray-50 rounded-[3rem] overflow-hidden border border-gray-100 shadow-2xl">
          ...
          <div className="divide-y divide-gray-200">
            {comparisonData.map((row, i) => (
              <motion.div 
                ...
                className="grid grid-cols-3 p-8 items-center hover:bg-white transition-colors"
              >
                ...
                <div className="text-center flex flex-col items-center">
                  <span className="text-gray-500 mb-2">{row.traditional}</span>
                  <X className="w-5 h-5 text-red-500" />
                </div>
                <div className="text-center flex flex-col items-center">
                  <span className="font-bold text-indigo-600 mb-2">{row.skilltrack}</span>
          ...
          <div className="p-10 bg-indigo-50 text-center">
