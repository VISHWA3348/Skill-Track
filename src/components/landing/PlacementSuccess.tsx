      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            <span className="text-xs font-bold uppercase tracking-widest bg-indigo-50 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400 px-3 py-1 rounded-full border border-indigo-100 dark:border-indigo-900/30">Hiring Ready</span>
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 dark:text-white leading-tight">Accelerate Student <br/>Placement Success</h2>
          ...
          <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {pillars.map((p, index) => (
              <div key={index} className="bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800 p-6 rounded-2xl hover:shadow-md transition-shadow">
                <div className="p-2.5 bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-400 rounded-xl w-fit mb-4 border border-gray-100 dark:border-gray-700">
