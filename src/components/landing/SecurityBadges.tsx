...
const SecurityBadges: React.FC = () => {
  return (
    <section className="py-16 bg-white border-t border-gray-100 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-2">Trust &amp; Compliance</p>
          <h2 className="text-2xl font-bold text-gray-900">Security Built into Every Layer</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {badges.map((b, index) => (
            <motion.div
              ...
              className="bg-slate-50 border border-slate-100 p-5 rounded-2xl text-center flex flex-col items-center"
            >
