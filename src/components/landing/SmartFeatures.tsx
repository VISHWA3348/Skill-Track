...
const SmartFeatures: React.FC = () => {
  return (
    <section id="smart-features" className="py-24 bg-white dark:bg-gray-950 transition-colors relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Powered by <span className="text-indigo-600 dark:text-indigo-400">Intelligence</span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group p-8 rounded-[2rem] bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:border-indigo-500 transition-all hover:shadow-2xl"
            >
