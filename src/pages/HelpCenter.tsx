      ...
      <main className="pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <div className="relative max-w-xl mx-auto">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm placeholder-gray-400 text-gray-900 transition-all shadow-sm"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {categories.map((c, i) => (
              <div key={i} className="bg-slate-50 border border-slate-100 p-6 rounded-2xl hover:shadow-md transition-shadow">
                ...
                <p className="text-xs font-semibold text-indigo-600 mt-1">{c.count}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
            <div className="lg:col-span-2">
              ...
              <div className="space-y-4">
                {popularArticles.map((art, i) => (
                  <div key={i} className="flex items-center space-x-3 p-4 bg-white border border-gray-100 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer">
                    <HelpCircle className="w-5 h-5 text-indigo-500 flex-shrink-0" />
                    <span className="text-sm font-semibold text-gray-700">{art}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-indigo-50/50 border border-indigo-100 p-8 rounded-3xl h-fit">
              ...
              <div className="space-y-4">
                <a href="mailto:zinointech@gmail.com" className="flex items-center space-x-3 text-sm font-semibold text-indigo-600 hover:underline">
                  <Mail className="w-5 h-5" />
                  <span>zinointech@gmail.com</span>
                </a>
                <a href="tel:+919113063448" className="flex items-center space-x-3 text-sm font-semibold text-indigo-600 hover:underline">
