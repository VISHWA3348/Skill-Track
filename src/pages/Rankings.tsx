...
export default function Rankings() {
  ...
  const getRankIcon = (index: number, rankNumber: number) => {
    switch (rankNumber) {
      ...
      default: return <span className="text-slate-400 font-bold w-6 text-center">{rankNumber}</span>;
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500">Top performers based on approved certifications, activities, and resume score.</p>
        </div>
              ...
              {loading ? (
                ...
                filteredRankings.map((student: any, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="text-sm text-slate-600 font-medium">{student.year}</span>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-sm text-slate-600 font-medium">{student.collegeId}</span>
                    </td>
