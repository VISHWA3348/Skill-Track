      ...
      <main className="pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            <div className="w-16 h-16 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            >
              Enterprise-Grade <span className="text-emerald-600 dark:text-emerald-400">Security</span>
            </motion.h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            {securityPillars.map((p, i) => (
              <div key={i} className="bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800 p-8 rounded-3xl flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6">
          ...
          <div className="bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800 rounded-3xl p-8 sm:p-12">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">Compliance & Framework Standards</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm text-center">
                <h3 className="font-bold text-gray-900 dark:text-white mb-2">SOC2 Ready</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                  System architecture conforms to SOC2 trust principles for security, availability, and processing integrity.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm text-center">
                <h3 className="font-bold text-gray-900 dark:text-white mb-2">GDPR Compliant</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                  Provides full control over user profiles, allowing students to access, export, or request deletion of data.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm text-center">
                <h3 className="font-bold text-gray-900 dark:text-white mb-2">ISO 27001 Aligned</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
