    ...
    <div className="min-h-screen bg-white transition-colors duration-500">
      ...
      <main className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 p-6 rounded-3xl mb-12 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center space-x-4">
              <div className="p-3 bg-emerald-500 text-white rounded-2xl shadow-lg shadow-emerald-200 animate-pulse">
                <CheckCircle className="w-7 h-7" />
              </div>
              <div>
                <h1 className="text-xl font-bold text-gray-950">All Systems Operational</h1>
                <p className="text-xs text-gray-500 mt-0.5">Everything is running smoothly. Uptime is calculated over the past 90 days.</p>
              </div>
            </div>
            ...
            <button 
              ...
              disabled={refreshing}
              className="flex items-center space-x-1.5 px-4 py-2 border border-slate-200 rounded-xl text-xs font-bold text-slate-600 bg-white shadow-sm"
            >
          ...
          <div className="space-y-6 mb-12">
            <h2 className="text-lg font-bold text-gray-900 px-1">Component Status</h2>
            <div className="grid gap-4">
              {systems.map((sys, i) => (
                <div key={i} className="bg-slate-50 border border-slate-100 p-6 rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div className="flex items-center space-x-4">
                    <div className="p-2.5 bg-white text-indigo-600 rounded-xl border border-gray-100">
                      <sys.icon className="w-5 h-5" />
                    </div>
                    <div>
                      <h3 className="text-sm font-bold text-gray-900">{sys.name}</h3>
          ...
          <div className="bg-slate-50 border border-slate-100 rounded-3xl p-6 sm:p-8">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Past Incidents</h2>
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-slate-200 pl-4">
                ...
                <h4 className="font-bold text-sm text-gray-900 mt-1">Scheduled Database Maintenance</h4>
              ...
              <div className="border-l-2 border-slate-200 pl-4">
                ...
                <h4 className="font-bold text-sm text-gray-900 mt-1">Minor Announcement Queue Delay</h4>
                <p className="text-xs text-gray-500 mt-1 leading-relaxed">
